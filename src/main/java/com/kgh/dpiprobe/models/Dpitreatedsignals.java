...
*/
    ...
    public Dpitreatedsignals(Integer Device_ID, Short Client_ID, Short Office_ID, Short BSOD_count, Short Hard_reset_count, Integer Boot_Speed, Integer Logon_Duration, Long CPU_Usage, Double Memory_Usage, Long System_Free_Space) {
